...
def gen_read_trace(
    ...
    while(ifmap_done == False) or (filt_done == False):
        ...
        for r in range(dim_rows):
            ...
            if(r == 0):
                print("r: "+str(r)+" ") 
                print("row_base_addr[r]: "+ str(row_base_addr[r])+ " ")
                print("row_clk_offset[r]: "+ str(row_clk_offset[r])+ " ")
                print("row_ofmap_idx[r]: "+ str(row_ofmap_idx[r])+ " ")
                print("v_fold_row[r]: "+ str(v_fold_row[r])+ " ")
